...
#if defined(WINDOWS) || defined(UNIX) || defined(MAEMO) || defined(Q_OS_QNX)
...
/** MouseHandler *********************************************/
/** This function receives mouse clicks/unclicks.           **/
/*************************************************************/
void (*MouseHandler)(int X,int Y,int State) = 0;
...
#if defined(UNIX) || defined(MAEMO) || defined(NXC2600) || defined(STMP3700) || defined(Q_OS_QNX)
...
/** SetMouseHandler() ****************************************/
/** Attach mouse handler that will be called when the       **/
/** mouse button is clicked or released.                    **/
/*************************************************************/
