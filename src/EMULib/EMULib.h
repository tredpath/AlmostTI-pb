...
/** MouseHandler *********************************************/
/** This function receives mouse clicks and unclicks.       **/
/*************************************************************/
extern void (*MouseHandler)(int X,int Y,int State);
...
#if defined(MAEMO) || defined(Q_OS_QNX)
...
/** SetMouseHandler() ****************************************/
/** Attach mouse handler that will be called when a button  **/
/** is pressed or released.                                 **/
/*************************************************************/
