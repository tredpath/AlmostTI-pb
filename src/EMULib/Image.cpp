...
#elif defined(UNIX) || defined(MAEMO) || defined(S60) || defined(UIQ) || defined(NXC2600) || defined(STMP3700)
...
#endif /* !UNIX && !MAEMO && !S60 && !UIQ && !STMP3700 && !NXC2600 */
...
#if (defined(BPP16) || defined(BPP24) || defined(BPP32)) && \
    (defined(MAEMO) || defined(S60)   || defined(UIQ) || defined(STMP3700))
...
#endif /* (MAEMO||S60||UIQ||STMP3700) && (BPP16||BPP24||BPP32) */
